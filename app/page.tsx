  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="text-center max-w-2xl mb-8 px-4">
        ...
        <p className="text-lg text-gray-700 mb-4">as a <span className='text-lg text-gray-700 font-semibold'>developer-turned-product manager</span> with a user-centric mindset, I excel in planning, executing and managing complex services and UX while understanding both business and technology.</p>
